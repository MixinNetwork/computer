...
func (node *Node) buildRefundTxs(ctx context.Context, req *store.Request, id string, am []*ReferencedTxAsset, receivers []string, threshold int) ([]*mtg.Transaction, string) {
